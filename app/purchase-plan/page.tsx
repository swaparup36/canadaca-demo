  ...
  return (
    <>
        ...
        <div className="flex justify-center items-center p-5 w-full h-[95svh]">
            <div className="p-5 md:p-10 md:w-[40%] w-[95%] min-h-[50svh] flex flex-col justify-between items-start" style={{ boxShadow: 'rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset' }}>
                ...
                <form className="w-full" onSubmit={handleSubmitPaymentForm}>
                    <h3 className="md:text-xl text-lg my-4 font-medium flex items-center">Scan the QR-Code to make payment <MoveRight className="ml-2" /></h3>
                    <div className="flex flex-col justify-center items-center my-2">
                        ...
                        <div className="flex md:flex-row flex-col justify-around items-center my-3">
